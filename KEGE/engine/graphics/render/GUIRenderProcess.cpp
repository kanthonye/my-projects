...
namespace kege{namespace gfx{
    ...
    void GUIRenderProcess::Render( gfx::RenderingSystem* renderer )
    {
    ...
    void GUIRenderProcess::UnInit( gfx::RenderingSystem* renderer )
    {
    }
    bool GUIRenderProcess::Init( gfx::RenderingSystem* renderer )
    {
        return true;
    }
}}
