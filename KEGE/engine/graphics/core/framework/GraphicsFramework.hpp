...
#include "../../../graphics/core/framework/Window.hpp"
#include "../../../graphics/core/framework/Shader.hpp"
#include "../../../graphics/core/framework/Texture2D.hpp"
#include "../../../graphics/core/framework/TextureCube.hpp"
#include "../../../graphics/core/framework/Framebuffer.hpp"
#include "../../../graphics/core/framework/RenderContext.hpp"
namespace kege{namespace core{
    ...
    public:
        ...
        virtual core::VAO* CreateVAO( core::VertexBuffer* vb, core::IndexBuffer* ib ) = 0;
        virtual VAO* CreateVAO() = 0;
        virtual VBO* CreateVBO() = 0;
        virtual UBO* CreateUBO() = 0;
        virtual IBO* CreateIBO() = 0;
        
        virtual RenderContext* CreateRenderSetting() = 0;
