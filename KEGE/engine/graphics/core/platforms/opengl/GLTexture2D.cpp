...
namespace kege{namespace core{
    ...
    cg::uint GLGetFormat(const shared::image& image)
    {
        switch ( image->chan() )
        {
            case 1: return core::RED; break;
            case 3: return core::RGB; break;
            case 4: return core::RGBA; break;
        }
        return GL_RED;
    }
