...
namespace kege{
    ...
    gfx::RawMaterial* LoaderMTL::Load(kege::ResourceManager* manager, const ds::string& filename)
    {
        ...
        gfx::RawMaterial* material = nullptr;
    ...
    LoaderMTL::LoaderMTL()
    :   kege::Loader<gfx::RawMaterial>("material","mtl")
    {}
}
