...
namespace kege{namespace dae{
    ...
    public:
        ...
        void GetVertexWeights(gfx::VertexBuffer& vw, gfx::VertexBuffer& vj, kege::XML* skin);
        void SetupSkeletalJointmap(gfx::Joint* hierarchy, gfx::Skeleton* skeleton);
        
        gfx::Skeleton* BuildSkeleton(kege::XML* instance, dae::ColladaVisualScenes& scenes);
        gfx::Mesh InstanceController(const ds::string& id, dae::ColladaGeometries geometries);
        
        gfx::VertexBuffer GetInverseBindMatrices(kege::XML* controller);
