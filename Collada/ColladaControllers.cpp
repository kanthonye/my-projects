...
namespace kege{namespace dae{
    ...
    void ColladaControllers::AttachSkeletalBonesToJoints(gfx::Joint* hierarchy, gfx::Skeleton* skeleton, kege::XML* skin)
    {
        ...
        gfx::VertexBuffer inv_binds = GetInverseBindMatrices(skin);
    ...
    gfx::Skeleton* ColladaControllers::BuildSkeleton(kege::XML* instance, dae::ColladaVisualScenes& scenes)
    {
    ...
    gfx::Mesh ColladaControllers::InstanceController(const ds::string& id, dae::ColladaGeometries geometries)
    {
        kege::XML* controller = GetController(id);
        kege::XML* skin = GetSkin(controller);
        
        gfx::VertexBuffer vw,vj;
    ...
    void ColladaControllers::GetVertexWeights(gfx::VertexBuffer& vw, gfx::VertexBuffer& vj, kege::XML* skin)
    {
        ...
        gfx::VertexBuffer weights = ToVertexBuffer(weights_source);
    ...
    gfx::VertexBuffer ColladaControllers::GetInverseBindMatrices(kege::XML* skin)
    {
