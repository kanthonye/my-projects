...
namespace kege{namespace gfx{
    ...
    class GLShaderProgram : public gfx::Shader
    {
    public:
        ...
        const gfx::GLUniform& GetUniformLocation(const char* name) const;
        ...
        GLShaderProgram(bool create);
        ~ GLShaderProgram();
        GLShaderProgram();
        
    private:
        
        mutable std::unordered_map<unsigned long, gfx::GLUniform> uniforms;
        static  std::unordered_map<unsigned long, gfx::GLUBO> ubos;
        cg::uint id;
    };
