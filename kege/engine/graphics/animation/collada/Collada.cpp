...
namespace kege{namespace dae{
    ...
    gfx::Gameobject* Collada::InstanceController(const ds::string& id, kege::XML* instance, kege::XML* node)
    {
        ...
        shared::Mesh mesh = controllers.InstanceController(url, geometries);
        shared::Skeleton skeleton = controllers.BuildSkeleton(instance, scenes);
        
        gfx::Entity* entity =  new gfx::Entity( id );
        entity->Attach( new gfx::AnimModel( mesh, skeleton ) );
    ...
    {
        ds::string url = RemoveHashtag(instance->GetAttr("url")->value);
        shared::Geometry geometry = geometries.InstanceGeometry( url );
        ...
        shared::Mesh mesh = new gfx::Mesh( geometry, dmatl );
        
        gfx::Entity* entity =  new gfx::Entity( id );
        entity->Attach( new gfx::Model( mesh ) );
        return entity;
    }
