...
namespace kege{namespace gfx{
    ...
    SkeletalAnimator::SkeletalAnimator(const shared::Skeleton& skeleton, gfx::SkeletalAnimation* animation)
    :   gfx::Component(kege::ENUM::_SKELETAL_ANIMATOR)
    ,   skeleton(skeleton)
    {
        Add(animation);
    }
    ...
    SkeletalAnimator::SkeletalAnimator()
    :   gfx::Component( gfx::Component::SKELETAL_ANIMATOR )
    ,   skeleton(nullptr)
    {}
}}
