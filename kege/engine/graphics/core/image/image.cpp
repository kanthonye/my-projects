...
namespace kege{
    ...
    kege::image<cg::uchar> open_image_tga(const ds::string & filename)
    {
        ...
        return kege::image<cg::uchar>(info.bitsperpixel/8, info.bitsperpixel, info.width, info.height, core::UNSIGNED_BYTE, data);
    }
    ...
    kege::image<cg::uchar> open_image_png(const ds::string & filename)
    {
        ...
        return kege::image<cg::uchar>(4, 32, height, width, core::UNSIGNED_BYTE, data);
    }
    ...
    kege::image<cg::uchar> open_image_bmp(const ds::string & filename)
    {
        ...
        return kege::image<cg::uchar>(info.bpp/8, info.bpp, info.width, info.height, core::UNSIGNED_BYTE, data);
    }
