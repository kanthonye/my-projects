...
namespace kege{namespace dae{
    ...
    void ColladaControllers::AttachSkeletalBonesToJoints(gfx::Joint* hierarchy, gfx::Skeleton* skeleton, kege::XML* skin)
    {
        ...
        gfx::DataBuffer<ds::string> joints = GetJoints(skin);
        
        // get the collada controller inverse bones matrix list.
        gfx::DataBuffer<float> inv_binds = GetInverseBindMatrices(skin);
    ...
    gfx::SharedSkeleton ColladaControllers::BuildSkeleton(kege::XML* instance, dae::ColladaVisualScenes& scenes)
    {
        ...
        return gfx::SharedSkeleton(skeleton);
    }
    
    gfx::SharedMesh ColladaControllers::InstanceController(const ds::string& id, dae::ColladaGeometries geometries)
    {
        kege::XML* controller = GetController(id);
        kege::XML* skin = GetSkin(controller);
        
        gfx::DataBuffer<float> vw,vj;
        GetVertexWeights(vw, vj, skin);
        
        gfx::Mesh* mesh = new gfx::Mesh;
        geometries.ContructGeometry(*mesh, skin->GetAttr("source")->value, vw, vj);
    ...
    void ColladaControllers::GetVertexWeights(gfx::DataBuffer<float>& vw, gfx::DataBuffer<float>& vj, kege::XML* skin)
    {
        ...
        gfx::DataBuffer<cg::uint> vcount, v;
        ...
        gfx::DataBuffer<float> weights = ToVertexBuffer(weights_source);
    ...
    gfx::DataBuffer<ds::string> ColladaControllers::GetJoints(kege::XML* skin)
    {
        ...
        return gfx::DataBuffer<ds::string>((int)stride, (int)size, na);
    }
    
    gfx::DataBuffer<float> ColladaControllers::GetInverseBindMatrices(kege::XML* skin)
    {
