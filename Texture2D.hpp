...
#include "../../graphics/framework/Texture.hpp"
namespace kege{namespace gfx{
    ...
    struct TextureInfo2D
    {
        ...
        TextureInfo2D()
        :   min_filter(gfx::LINEAR_FILTER)
        ,   mag_filter(gfx::LINEAR_FILTER)
        ,   wrap_x(gfx::REPEAT)
        ,   wrap_y(gfx::REPEAT)
        ,   gen_mipmap(false)
        {}
    ...
    class Texture2D : public kege::gfx::Texture
    {
    public:
